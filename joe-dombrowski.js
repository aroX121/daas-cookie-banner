// ==========================================
//  JOE DOMBROWSKI SITE TRACKING ENGINE
// ==========================================

// 1. RETARGET IQ LOADER (Joe Dombrowski Specific Pixel)
window.loadRetargetIQ = function () {
    ...
    (function (s, p, i, c, e) {
        ...
        s.pixelClientId = i;
    })(window, "https://app.retargetiq.com/script", "joe-dombrowski", document, "script");
