// ==========================================
// CLIENT: DAAS - IAN BAGG TRACKING ENGINE
// (Self-Contained: GTM + Meta Pixel + Retarget IQ)
// ==========================================

// 0. IMMEDIATE CONSENT DEFAULT (REVOKE UNTIL GRANTED)
window.fbq = window.fbq || function () { (window.fbq.q = window.fbq.q || []).push(arguments); };
window.dataLayer = window.dataLayer || [];
function gtag() { window.dataLayer.push(arguments); }

var initialConsentCheck = (function () {
    var match = document.cookie.match(new RegExp('(^| )daas_ianbagg_consent=([^;]+)'));
    return match ? match[2] : null;
})();

if (initialConsentCheck !== 'granted') {
    fbq('consent', 'revoke');
...
// 1. RETARGET IQ LOADER (Ian Bagg Specific Pixel)
window.loadRetargetIQ = function () {
    ...
    (function (s, p, i, c, e) {
        ...
        s.pixelClientId = i;
    })(window, "https://app.retargetiq.com/script", "ian-bagg", document, "script");
    window.retargetIQLoaded = true;
};

// 2. LITERAL COOKIE HANDLERS
function setCookieChoice(choice) {
    document.cookie = "daas_ianbagg_consent=" + choice + "; max-age=31536000; path=/";
}
...
function enableTracking() {
    ...
    // 2. Wakes up Meta Pixel
    if (typeof fbq === 'function') {
        fbq('consent', 'grant');
    }

    // 3. Wakes up Retarget IQ
...
// 4. CUSTOM BANNER GENERATOR (Compact Dark Theme)
function showBanner() {
